...
WebUI.navigateToUrl('http://13.127.216.43/advertisement/admin')

WebUI.navigateToUrl('http://13.127.216.43/employer/agentlogin.jsp')

WebUI.delay(3)

//WebUI.click(findTestObject('Page_topjobs - OrganisationLogin/input_User Name_txtUserName'))
//WebUI.delay(3)
WebUI.setText(findTestObject('Object Repository/input_User Name_txtUserName'), 'kalpani')
