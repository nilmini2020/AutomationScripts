...
* This is test case for Verify Partners link
* Modification History:
* Date       Version     Modified By     Description
* 20200505   1.0         DH              Initial creation
*/
...
WebUI.verifyElementVisible(findTestObject('Object Repository/ApplicantMyJobs/pnlEmailApplicationPanel1'))
WebUI.verifyElementVisible(findTestObject('Object Repository/ApplicantMyJobs/pnlFlaggedVacancyPanel1'))
WebUI.verifyElementVisible(findTestObject('Object Repository/ApplicantMyJobs/pnlOnlineApplicationPanel1'))
