...
String concatname=title+'.'+' '+oname+' '+lname

WebUI.click(findTestObject('Object Repository/ApplicantCommonProfile/lnkViewProfileHTML'))
WebUI.delay(6)
System.out.print(concatname)
WebUI.switchToWindowIndex(1)
String result=WebUI.getText(findTestObject('Object Repository/ApplicantProfileHTML/lblfullname'))

WebUI.verifyMatch(result, concatname, false)
