...
WebUI.delay(5)
WebUI.scrollToElement(findTestObject('Object Repository/ApplicantProfile/txtSecretAnswer'), 3)
WebUI.sendKeys(findTestObject('Object Repository/ApplicantProfile/txtSecretAnswer'), 'test answer')
WebUI.click(findTestObject('Object Repository/ApplicantProfile/btnUpdateDetails'))
WebUI.delay(1)
